...
import { defaultNodeAddress, defaultNodeBroker, getSyncModes, generateClusterDetails } from './clusterutils';
import {
                            ...
                            <Card variant="outlined">
                                ...
                                <CardContent style={{ paddingTop: '0px' }}>
                                    <SelectNodeComponent
                                        ...
                                        message={
                                            'Note that you may need to adjust IP fields, e.g. if nodes are in a different private network'
                                        }
                                    />
                                </CardContent>
                            </Card>
