...
const ConnectionNewComponent = ({ connections, tlsFeature, handleCloseDialog, backendParameters }) => {
    ...
    const checkAndSetErrors = () => {
        ...
        if (connection[clientPrivateKeyFieldName] && !connection[clientCertificateFileFieldName]) {
            ...
            (connection[clientCertificateFieldName] && connection[clientPrivateKeyFileFieldName]) ||
            (!connection[clientCertificateFieldName] && !connection[clientPrivateKeyFileFieldName])
        ) {
            setErrors((prevState) => ({
                ...prevState,
                                ...
                                <TextField
                                    ...
                                    InputProps={{
                                        endAdornment: (
                                            <IconButton
                                                className={
                                                    connection[customCACertificateFileFieldName]
                                                        ? classes.crossButton
                                                        : classes.invisible
                                                }
                                                size="small"
                                ...
                                <TextField
                                    ...
                                    InputProps={{
                                        endAdornment: (
                                            <IconButton
                                                className={
                                                    connection[clientCertificateFileFieldName]
                                                        ? classes.crossButton
                                                        : classes.invisible
                                                }
                                                size="small"
                                ...
                                <TextField
                                    ...
                                    InputProps={{
                                        endAdornment: (
                                            <IconButton
                                                className={
                                                    connection[clientPrivateKeyFileFieldName]
                                                        ? classes.crossButton
                                                        : classes.invisible
                                                }
                                                size="small"
