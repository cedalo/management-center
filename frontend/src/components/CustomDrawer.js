        ...
        >
            ...
            <div>
                <Box style={{ overflow: 'hidden', height: '100%' }}>
                    ...
                    <Divider />
                    {atLeastEditor(userProfile, currentConnectionName) && (
                        <>
                            <List>
                                {open ? (
                                    <ListSubheader className={classes.menuSubHeader}>Dynamic Security</ListSubheader>
                                ) : null}
                                <ListItemLink
                                    tour="navbar-clients"
                                    classes={classes}
                    ...
                    >
                        <List style={{ background: 'none' }}>
                            <List style={{ background: 'none' }}>
                                {open ? (
                                    <ListSubheader className={classes.menuSubHeader}>Configuration</ListSubheader>
                                ) : null}
                            ...
                            <Divider />
                            <Tooltip enterDelay={500} placement="right" title="Admin" key="admin">
                                <MenuItem button onClick={() => setAdminOpen(!adminOpen)}>
                                    <ListItemIcon style={{}}>
                                        <MoreIcon />
                                    </ListItemIcon>
                                    <ListItemText
