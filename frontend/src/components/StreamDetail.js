...
const StreamDetail = (props) => {
    ...
    const validate = () => {
        if (editMode) {
            return updatedStream.streamname !== '' && updatedStream.sourcetopic !== '';
        } else {
                    ...
                    <FormControlLabel
                        control={
                            <Switch
                                color="primary"
                                disabled={!editMode}
                                checked={typeof updatedStream.process === 'undefined' || updatedStream.process === true}
                                onClick={(event) => {
                                    if (editMode) {
                                        setUpdatedStream({
                                            ...updatedStream,
                    ...
                    <FormControlLabel
                        control={
                            <Switch
                                disabled={!editMode}
                                color="primary"
                                checked={typeof updatedStream.persist === 'undefined' || updatedStream.persist === true}
                                onClick={(event) => {
                                    if (editMode) {
                                        setUpdatedStream({
                                            ...updatedStream,
                    ...
                    <FormControlLabel
                        control={
                            <Switch
                                disabled={!editMode}
                                color="primary"
                                checked={typeof updatedStream.active === 'undefined' || updatedStream.active === true}
                                onClick={(event) => {
                                    if (editMode) {
                                        setUpdatedStream({
                                            ...updatedStream,
