...
const getPremium = () => {
  return (
    <span>
      <PremiumVersionIcon
        fontSize="small"
        style={{ color: "#ffc107", verticalAlign: "middle" }}
      />{" "}
      Premium
    </span>
  );
...
const InfoPage = (props) => {
  ...
  const [response, loading, hasError] = useFetch(
    "http://localhost:8088/api/update"
  );
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>
                    ...
                    {moment
                      .unix(response.lastUpdated)
                      .isAfter(moment(version.buildDate)) ? (
                      <Button
                      ...
                      <span className={classes.updateButton}>
                        You are up to date!
                      </span>
                    )}
                  </TableCell>
