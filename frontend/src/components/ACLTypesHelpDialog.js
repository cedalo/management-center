...
const aclTypeHelp = [
    ...
    },
    {
        ...
        description:
            'Restrict the topics this role is allowed to use when receiving published messages from the broker.',
    },
    {
                    ...
                    {aclTypeHelp.map((help, index) => (
                        <ListItem key={index} divider alignItems="flex-start">
                            <ListItemText className={classes.acltype}>
                                <Typography className={classes.acltype}>{help.acltype}</Typography>
                            </ListItemText>
