                        ...
                        <div>
                            ...
                            {infoIcon ? (
                                <Tooltip title={infoTooltip}>
                                    <IconButton className={classes.info} size="small" id={id} aria-label="info">
                                        <InfoOutlined
                                            onClick={(event) => {
            ...
            <CardContent>
                <Grid container style={{ height: chart ? '180px' : null }} spacing={3}>
                    ...
                    {infos.map((info) =>
                        info.hide !== true ? (
                            <Grid
                                style={{ display: 'flex', padding: '4px 12px', marginTop: info.space ? '10px' : '0px' }}
                                justifyContent={alignment === 'table' ? 'flex-start' : 'space-between'}
                                xs={12}
                                item
                            >
                                <Typography
