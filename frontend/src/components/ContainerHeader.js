    ...
    return (
        <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                {small ? null : <Typography style={{ fontSize: '10pt' }}>{props.subTitle}</Typography>}
                {props.children ? (
                    <div
                        style={{
            ...
            {props.featureWarning ? (
                <Alert severity="warning" style={{ height: 'fit-content', marginTop: '15px' }}>
                    ...
                    {props.featureWarning} is a premium feature. For more information visit{' '}
                    <a style={{ color: theme.palette.primary.main }} href="https://www.cedalo.com">
                        cedalo.com
                    </a>{' '}
                    or contact us at{' '}
                    <a style={{ color: theme.palette.primary.main }} href="mailto:info@cedalo.com">
                        info@cedalo.com
                    </a>
                    .
                </Alert>
