...
const integrations = [
    {
        ...
        descriptions: 'JWT (JSON Web Tokens) is used as an effective and scalable way of authentication by transmitting information as cryptographically signed JSON objects.',
    ...
    },
    {
        ...
        descriptions: 'LDAP is a protocol commonly used for authentication and authorization purposes, especially in enterprise environments where central management of user credentials is needed.',
    ...
    },
    {
        ...
        descriptions: 'CockroachDB is a cloud-native, distributed SQL database designed for horizontal scalability, strong consistency, and survivability.',
    ...
    {
        name: 'MariaDB Bridge',
        descriptions: 'MariaDB is an open-source relational database derived from MySQL, featuring enhanced performance, storage engines, and cutting-edge features.',
    ...
    },
    {
        ...
        descriptions: 'Redshift is a fast, scalable data warehouse that extends analytics capabilities across the enterprise with SQL-based querying.',
    ...
    },
    {
        ...
        descriptions: 'OracleDB is a comprehensive, enterprise-grade relational database known for its data integrity, security features, and strong performance.',
    ...
    },
    {
        ...
        descriptions: 'Microsoft SQL Server is a robust relational database management system known for its complex data analytics and transaction processing capabilities.',
                ...
                <>
                    ...
                    <Box style={{textAlign: 'center', marginTop: '36px'}}>
                        <Typography style={{color: '#a6a6a6', fontSize: 10}}>
                            The content displayed on this page includes third-party logos among other visuals that are trademarks of their respective owners. These logos and visuals are used only to indicate that Pro Mosquitto has developed integrations with the corresponding products. Cedalo expressly disclaims any ownership of these logos and any implied legal association or partnership with the trademark holders. Additionally, please be aware that some of the visual materials used on this page are not official logos but are utilized solely as generic placeholder images. The use of these visuals does not imply any association with or endorsement by the companies whose products are being represented. Cedalo does not hold any rights to the integrated products, their logos, other branding or any other proprietary materials. For more detailed information about the products with which Pro Mosquitto is integrated, please visit the official websites of the respective companies.
                        </Typography>
                    </Box>
                </>
            </ContentContainer>
