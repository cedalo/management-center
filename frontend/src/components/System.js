...
const System = ({ systemStatus }) => {
  ...
  const otherMessages = (totalMessages - parseInt(systemStatus?.$SYS?.broker?.publish?.messages?.sent)) / totalMessages * 100;
    ...
    <div>
      <Container maxWidth={false}>
        <Grid container spacing={3}>
          ...
          <Grid item lg={4} sm={4} xl={4} xs={12}>
            <Chart title="Sent messages by type" data={data} dataDescriptions={dataDescriptions} />
          </Grid>
        </Grid>
      </Container>
    </div>
