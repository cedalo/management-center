...
const define = {
    ...
    'process.env.CEDALO_MC_BROKER_CONNECTION_HOST_MAPPING':
        `"${process.env.CEDALO_MC_BROKER_CONNECTION_HOST_MAPPING}"` || '""',
    'process.env.CEDALO_MC_BROKER_CONNECTION_MQTT_EXISTS_MAPPING':
        `"${process.env.CEDALO_MC_BROKER_CONNECTION_MQTT_EXISTS_MAPPING}"` || '""',
    'process.env.CEDALO_MC_BROKER_CONNECTION_MQTTS_EXISTS_MAPPING':
        `"${process.env.CEDALO_MC_BROKER_CONNECTION_MQTTS_EXISTS_MAPPING}"` || '""',
    'process.env.CEDALO_MC_BROKER_CONNECTION_WS_EXISTS_MAPPING':
        `"${process.env.CEDALO_MC_BROKER_CONNECTION_WS_EXISTS_MAPPING}"` || '""',
    'process.env.MOSQUITTO_PROXY_URL': process.env.MOSQUITTO_PROXY_URL || '""',
    'process.env.CEDALO_MC_DEV_CLUSTER_NODE_BROKER_PREFIX': process.env.CEDALO_MC_DEV_CLUSTER_NODE_BROKER_PREFIX
        ? `"${process.env.CEDALO_MC_DEV_CLUSTER_NODE_BROKER_PREFIX}"`
        : '""',
    'process.env.CEDALO_MC_DEV_CLUSTER_NODE_ADDRESS_PREFIX': process.env.CEDALO_MC_DEV_CLUSTER_NODE_ADDRESS_PREFIX
        ? `"${process.env.CEDALO_MC_DEV_CLUSTER_NODE_ADDRESS_PREFIX}"`
        : '""',
};
