...
const define = {
	...
	'process.env.CEDALO_MC_DEV_CLUSTER_NODE_BROKER_PREFIX': process.env.CEDALO_MC_DEV_CLUSTER_NODE_BROKER_PREFIX ? `"${process.env.CEDALO_MC_DEV_CLUSTER_NODE_BROKER_PREFIX}"` : '""',
	'process.env.CEDALO_MC_DEV_CLUSTER_NODE_ADDRESS_PREFIX': process.env.CEDALO_MC_DEV_CLUSTER_NODE_ADDRESS_PREFIX ? `"${process.env.CEDALO_MC_DEV_CLUSTER_NODE_ADDRESS_PREFIX}"` : '""'
};
